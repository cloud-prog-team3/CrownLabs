...
var _ = Describe("Instautoctrl-expiration", func() {
	...
	Context("Testing maximum deletion time", func() {
		It("Should succeed: the persistent VM reached the maximum lifespand and it is deleted", func() {
			...
			By("waiting for the non-persistent VM to reach the maximum deletion time")
